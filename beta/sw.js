/* This worker owns only the beta scope and beta-prefixed caches. */
var CACHE = 'pts-flightapp-beta-v122-1';
var PREFIX = 'pts-flightapp-beta-';
var ASSETS = [
  './PTS_FlightApp.html', './tab-transfer.js', './manifest.webmanifest',
